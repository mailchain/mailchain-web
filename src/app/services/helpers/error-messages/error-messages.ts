export const errorMessages = {
  ...
  // client not running
  "clientNotRunningErrorMessage": "<p>The Mailchain client does not seem to be running.</p><p>Please visit <a href=\"https://docs.mailchain.xyz/troubleshooting/common-inbox-errors\" target=\"_blank\">Docs: common inbox errors</a> to see how to fix this.</p>",
